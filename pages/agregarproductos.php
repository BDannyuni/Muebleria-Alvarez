...
<body>
    ...
    <div id="main-wrapper">
        ...
        <!-- Content body start -->
        <div class="content-body" style="background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(../assets/images/productos/salaprincipal.jpg); 
	background-size:cover;"><br><br>
                ...
                <div class="card">
                    <div class="card-body">
                            <form class="form-container" method="post" enctype="multipart/form-data">
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <input type="text" class="form-control rounded mb-3" name="nombre_prod"
                                                id="nombre_prod" placeholder="Ingrese el Nombre del Producto..."
                                                required>
                                        </div>
                                        <div class="form-group">
                                            <select class="form-control rounded mb-3" name="id_departamento"
                                                id="id_departamento" required>
                                                <option value="">Selecciona un departamento</option>
                                                <?php foreach ($result_departamento as $row_departamento) { ?>
                                                <option value="<?php echo $row_departamento['id_departamento']; ?>"
                                                    <?php echo (isset($_POST['id_departamento']) && $_POST['id_departamento'] == $row_departamento['id_departamento']) ? 'selected' : ''; ?>>
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control rounded" name="descripcion_prod"
                                            id="descripcion_prod" rows="6"
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        <input class="form-control rounded" type="number" step="0.01" name="precio_prod"
                                            id="precio_prod" placeholder="Ingresa el Precio: $0.00" required>
                                    </div>
                                    <div class="col-lg-4">
                                        <input class="form-control rounded" type="number" name="stock_prod"
                                            id="stock_prod" placeholder="Ingrese la cantidad de stock" required>
                                    </div>
                                    <div class="col-lg-4">
                                        <select class="form-control rounded" name="proveedor" id="proveedor" required>
                                            ...
                                            <option value="<?php echo $row_proveedor['id_proveedor']; ?>"
                                                <?php echo (isset($_POST['id_proveedor']) && $_POST['id_proveedor'] == $row_proveedor['id_proveedor']) ? 'selected' : ''; ?>>
                                    ...
                                    <div class="col-lg-8">
                                        <div class="custom-file">
                                            <input type="file" name="image" id="image" accept="image/*"
                                                class="custom-file-input rounded" required
                                                onchange="updateFileName(this)">
                                            <label id="imageLabel" class="custom-file-label">Ingrese la Imagen del
                                                Producto</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-3">
                                        <input type="text" class="form-control rounded" name="marca" id="marca"
                                    ...
                                    <div class="col-lg-3">
                                        <select class="form-control rounded" name="id_material" id="id_material"
                                            required>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12 text-center">
                                        <button type="submit" class="btn btn-primary" name="submit">Añadir
                                            Producto</button>
                                    </div>
                                </div>
                            </form>
        ...
        <div class="footer">
            <div class="copyright">
                <p>Copyright &copy; Todos Los Derechos Reservados | Esta Pagina esta Hecha solo para fin educativo <br>
                    Hecho por <a href="https://colorlib.com" target="_blank">Brandon</a> y <a
                        href="https://colorlib.com" target="_blank">Maximo</a></p>
            </div>
        </div>
        <!-- Footer end -->
    </div>
